ModName             =   "Modular_Flight_Framework"
ModAuthor           =   "Hypn0tick"
LuaAuthor           =   "Hypn0tick"
GameVersion         =   "3.99+"
ModVersion          =   "1.0"
...
Disable_AutoBrake                   =   true    --  When set to "true", the script will disable most automatic brake settings.
...
Disable_AutoAvoidance               =   true    --  When set to "true", the script will disable all flight automatic avoidance parameters.

Enable_Warp_Flight_Changes          =   true    --  When set to "true", the script will enable changes to warp drive parameters.
                                                --  Note: This does not include changes to freighters, which are handled by the "Enable_Freighter_Changes" variable.

Enable_Pulse_Flight_Changes         =   true    --  When set to "true", the script will enable changes to pulse flight (base numbers located at the top of the "Base Numbers" section).

Enable_Pulse_Distance_Changes       =   true    --  When set to "true", the script will enable changes to pulse distance and time minimums (base numbers located at the top of the "Base Numbers" section).
                                                --  Note: This does not include changes to pulse flight speeds. That is controlled by the "Enable_Flight_Changes" variable.

Enable_Freighter_Changes            =   true    --  When "true", the script will enable changes to freighter flight mechanics.
                                                --  This includes changes to warp distances, friendly fire ranges, summon distances, etc.

Disable_Pulse_Asteroids             =   true    --  This variable toggles whether asteroids will be generated while using the pulse engine.
...
Disable_Speed_Lines                 =   true    --  When set to "true", the script will remove the "speed line" effect while flying.

Enable_Planet_Reverse               =   true    --  When "true", the script will alter values to allow for backwards planetary flight.
...
Abandoned_Freighter_Enable_Saving   =   true    --  When "true", the game will save when a player exits their ship on an abandoned freighter.

Asteroid_Hit_Damage_Mult            =   10      --  Multiplier applied to damage from asteroid impacts.
                                                --  By default, the script will multiply impact damage by 10 (10,000 x 10 = 100,000)

Ship_Loot_Distance_Mult             =   9       --  This value sets the multipler for the distance at which loot will be attracted to the ship.
                                                --  By default, the script will increase this by a multiple of 10 (120u x 10 = 1,080u)

Ship_Inventory_Distance_Mult        =   6       --  Multiplier for ship inventory interaction range.
                                                --  By default, the script will increase this by a multiple of 6 (50u x 6 = 300u).

Ship_Teleporter_Distance_Mult       =   7.5     --  Multiplier for ship Teleport Receiver inventory interaction range bonus.
                                                --  By default, the script will increase this by a multiple of 6 (100u x 7.5 = 750u).

Ship_Scan_Distance_Mult             =   2       --  Multiplier for the radius of the ship's scaner range.
                                                --  By default, this doubles the ship scanner range from 10000u to 20000u.

Ship_Scan_Cooldown_Mult             =   0.3     --  This sets the ship scanner cooldown; The lower the number, the quicker you're able to scan again.
                                                --  By default, this reduces scan cooldown by 70% (10 x 0.3 = 3 seconds).

Ship_Scan_Speed_Mult                =   0.75    --  This sets the speed of the scan pulse; The lower the number, the quicker it scans.
                                                --  By default, this speeds up the scanning process by 25% (3 x 0.75 = 2.25 seconds).

Ship_Launch_Cost_Mult               =   0.82    --  This sets the ship launch fuel cost. The lower the number, the cheaper it gets.
                                                --  Setting this to "0" makes launching your ship drain no fuel, setting it to "0.5" halves the amount, etc.
                                                --  By default, this will reduce the starship launch fuel cost from "50" to "41" (50 * 0.82).

Buildings_Scan_Distance_Mult        =   3       --  Multiplier for the discovery radius of unknown buildings when scanning on a planet's surface.
                                                --  By default, this doubles the ship scanner range from 600u to 1200u.

Buildings_Icon_Distance_Max_Mult    =   3       --  Multiplier for the range at which icons will start to pop up when scanning.
                                                --  By default, this triples the range at which icons will start to show up when you scan.

Buildings_Scan_Number_Max_Mult      =   1.5     --  This will determine how many buildings you can scan at once.
...
-- Freighter Settings
----------------------------------------------
Freighter_Remove_Multiplayer_Limit          =   true    --  When "true", the script will remove the game's default limit of one freighter summon per system.
                                                        --  This allows multiple players to summon their capital ships within a system.
                                                        --  Game default: false. Mod default: true.

Freighter_Spawn_Capital_First               =   true    --  When set to "true", this will replace the first freighter spawn in a given system with its capital freighter.
...
Freighter_Ignore_FriendlyFire_Distance      =   10000    --  This value determines the range at which freighters will ignore friendly fire.
                                                        --  Game default: 10000. Mod default: 10000.

Freighter_Tractor_Range                     =   300     --  This value determines the range at which a freighter's tractor beam will grab hold of the player's ship.
                                                        --  Game default: 500. Mod default: 300.

Freighter_Planet_Summon_Distance_Offset     =   -200    --  This value determines the distance offset from a planet's surface when summoning a freighter.
                                                        --  By default, the script will reduce the offset from a default of "1000" to "-200".

Freighter_Hyperdrive_Core_Distance_Mult     =   8       --  This value sets a multiplier for freighter hyperdrive ranges at each tier.
                                                        --  By default, this will increase freighters' hyperdrive ranges by 8x.

Freighter_Hyperdrive_Bonus_Distance_Mult    =   5       --  This value sets a multiplier for the bonus granted by freighter hyperdrive upgrade modules.
                                                        --  By default, this will increase bonuses by 5x.

Freighter_Hyperdrive_RGB_Distance_Mult      =   10      --  This value sets a multiplier for the bonus granted by the RGB hyperdrive upgrades (ones that let you access coloured star systems).
                                                        --  By default, this will increase bonuses by 10x.


----------------------------------------------
-- Space Flight Settings
----------------------------------------------
Space_Speed_Max_Mult                =   2.5     --  This value sets a multiplier for the maximum speed of all ships.

Space_Speed_Min_Mult                =   1       --  This value sets a multiplier for the minimum speed for of all ships.

Space_Boost_Speed_Mult              =   1.4     --  This value sets a multiplier for the maximum boost speed of all ships.

Space_Thrust_Mult                   =   1.2     --  This value sets a multiplier for the thrust (acceleration) of all ships.

Space_Boost_Thrust_Mult             =   0.7     --  This value sets a multiplier for the thrust (acceleration) for all ships while boosting.

Space_Turn_Strength_Mult            =   0.8     --  This value sets a multiplier for the turn strength (maneuverability, more or less) for all ships during normal space flight.
...
Pulse_Speed_Mult                    =   1.4     --  This value sets a multiplier for the speed of the pulse drive.
                                                --  By default, the script will increase this speed by 40%.

Pulse_Exit_Speed_Mult               =   8       --  This value sets a multiplier for the speed of the pulse drive.
                                                --  By default, the script will multiply this speed by 10x.

Pulse_Fuel_Time_Mult                =   0.5     --  This value determines the time between the fuel consumption "ticks" when using the pulse drive.
...
Pulse_Stop_Distance_Planet_Mult     =   0.2     --  This value sets a multiplier for the distance from the targetted planet at which the player's ship will disengage the pulse engine.
                                                --  By default, the script will reduce this distance by 75%.
                                                --  Game default: 5000. Mod default: 1000 (5000 x 0.20).

Pulse_Stop_Distance_Default_Mult    =   0.5     --  This value sets a multiplier for the default distance from targetted POIs at which the player's ship will disengage the pulse engine.
                                                --  By default, the script will reduce this distance by 50%.

Warp_Jump_Distance_Mult             =   1.5     --  This value sets a multiplier for the base distance a ship can travel when using the warp drive.
...
Planet_Speed_Max_Mult       =   2.5     --  This sets a multiplier for the maximum flight and maximum boost speed inside a planet's atmosphere (eg. 3 would mean flight speed would be at three times the normal speed).
                                        --  Base game default: 1. Mod default: 2.

Planet_Boost_Speed_Mult     =   4       --  Multiplier for strength of the boost acceleration. Set this depending on your Planet_Speed_Max_Mult setting.
                                        --  I recommend setting it to 3.5 for Planet_Speed_Max_Mult = 2. Set to 2 if Planet_Speed_Max_Mult = 1.

Planet_Turn_Strength_Mult   =   0.4     --  Change this depending on your Planet_Speed_Max_Mult setting. For Planet_Speed_Max_Mult = 1 set Planet_Turn_Strength_Mult = 1 as well. For Planet_Speed_Max_Mult = 2 I recommend setting Planet_Turn_Strength_Mult = 0.5, etc.
...
Pulse_Speed_Acceleration_Time       =   5       --  Default: 0.1
Pulse_Cooldown                      =   5       --  Default: 2
...
Pulse_HUD_AttractAngle              =   5       --  Default: 10
Pulse_HUD_AttractAngle_Station      =   3       --  Default: 5
Pulse_HUD_AttractAngle_Dense        =   3       --  Default: 4
...
Pulse_Min_Anomaly_Distance          =   1000    --  Default: 3000
Pulse_Min_SpaceAnomaly_Distance     =   700     --  Default: 700
Pulse_Min_Freighter_Distance        =   600     --  Default: 800
Pulse_Min_Freighter_Angle           =   30      --  Default: 10
Pulse_Min_ShipDistance              =   2000    --  Default: 2000
Pulse_Min_ShipNear_MinTime          =   15      --  Default: 10
Pulse_Min_Ship_LastHitTime          =   20      --  Default: 10
Pulse_Min_Combat_MinBattleTime      =   20      --  Default: 35
Pulse_Min_Combat_MinTime            =   30      --  Default: 25
Pulse_Min_FreighterCombat_MinTime   =   45      --  Default: 55
...
----------------------------------------------
Nexus_Spawn_Rotation        =   0       --  This value determines the rotation of the Nexus when spawned.
                                        --  Game default: 15

Nexus_Spawn_Pitch           =   0       --  This value determines the pitch of the Nexus when spawned.
                                        --  Game default: 15

Nexus_Spawn_Distance        =   -15000  --  This value determines the distance of the Nexus when spawned.
                                        --  Game default: -9000
...
Ship_Engine_Data =
{
   ...
   {    
        ...
        ["DATA"] =
        {
           ...
           {"CombatEngine", ControlLight_Combat_Thrust_Force*Space_Thrust_Mult, ControlLight_Combat_Speed_Max*Space_Speed_Max_Mult, ControlLight_Combat_Speed_Min*Planet_Speed_Min_Mult, ControlLight_Combat_Falloff, Combat_MinSpeed_Force, ControlLight_Combat_Boost_Thrust_Force*Space_Boost_Thrust_Mult, ControlLight_Combat_Boost_Speed*Space_Boost_Speed_Mult, ControlLight_Combat_Boost_Falloff, ControlLight_Combat_Boost_TurnDamp, ControlLight_Combat_DirectionBrake_Min*Combat_DirectionBrake_Mult, ControlLight_Combat_DirectionBrake_Max*Combat_DirectionBrake_Mult, ControlLight_Combat_Reverse_Brake, ControlLight_Combat_Overspeed_Brake, ControlLight_Combat_LowSpeed_TurnDamper, ControlLight_Combat_TurnBrake_Min*Combat_TurnBrake_Mult, ControlLight_Combat_TurnBrake_Max*Combat_TurnBrake_Mult, ControlLight_Combat_Turn_Strength*Combat_Turn_Strength_Mult, ControlLight_Combat_Roll_Amount, ControlLight_Combat_Roll_Force, "2", "0.4", "4", "0.1", "0.05", "0.15", "60", "10", "1.2", "0.99"},
...
{
  ["MOD_FILENAME"]      =   ModAuthor.."-"..ModName.."-"..ModVersion..".pak",
